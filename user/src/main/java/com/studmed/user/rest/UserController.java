...
import com.studmed.user.domain.service.UserCommandService;
import com.studmed.user.domain.service.UserQueryService;
import com.studmed.user.rest.resource.CreateUserResource;
import com.studmed.user.rest.resource.UpdateUserResource;
import com.studmed.user.rest.resource.UserResource;
import com.studmed.user.rest.transform.CreateUserCommandFromResourceAssembler;
import com.studmed.user.rest.transform.UpdateUserCommandFromResourceAssembler;
import com.studmed.user.rest.transform.UserResourceFromEntityAssembler;
