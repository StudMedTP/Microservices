...
public class AttendanceContract extends Contract {
    ...
    protected AttendanceContract(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider gasProvider) {
        super(BINARY, contractAddress, web3j, credentials, gasProvider);
    }

    public static AttendanceContract load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider gasProvider) {
        return new AttendanceContract(contractAddress, web3j, credentials, gasProvider);
    }
